...
export default function MenuExploreCard({ img, type, description }: MenuExplorerCardTp) {
    ...
    >
        <div className="sm:w-120 w-full  relative h-80 rounded-sm overflow-hidden bg-linear-to-t from-black to-transparent  shadow-[20px] shadow-red-500 cursor-pointer group">
