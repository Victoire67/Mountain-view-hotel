    ...
    return <div >
        ...
        <div className="w-full h-screen bg bg-center bg-cover">
            ...
            >
                <div className="mt-16 mx-auto flex items-center place-content-center gap-8">
                    <button className="text- px-8 py-2 bg-[#FFB82B] text-black border-amber-200 border hover:text-[#FFB82B] hover:bg-transparent cursor-pointer transform transition-colors">MENU</button>
                    <button className="text-[#FFB82B] px-8 py-2 border-amber-200 border hover:text-black hover:bg-[#FFB82B] cursor-pointer transform transition-colors">CONTACT</button>
                </div>
            </motion.div>
        </div>
        ...
        <div>
            ...
            <div className="sm:flex items-center gap-8 place-content-center">
                <MenuExploreCard img={food} type="Food" description="Explore the best food in Rwanda" />
