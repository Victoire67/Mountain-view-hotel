...
export default function MainContentPage({ type }: { type: string }) {
    ...
    const imageUrl = new URL(`${data[dataOnView]?.img}`, import.meta.url).href;
    console.log(data[dataOnView].img)
        ...
        <div className="sm:pt-[20%] pt-[50%] animation-appear text-center h-screen bg-cover bg-center bg-blend-multiply bg-linear-to-t from-black/90 to-transparent" style={{ backgroundImage: `url(${imageUrl})` }}>
            <AnimatePresence mode="wait">
                ...
                >
                    ...
                    <h1 className="text-5xl font-bold text-white">{data[dataOnView].description}</h1>
                    <p className="flex items-center gap-2 mx-auto place-content-center bg-black w-fit mx-auto text-white">
                        ...
                        <span className="text-white">PREPARATION TIME : {data[dataOnView].prep_time}</span>
                    </p>
